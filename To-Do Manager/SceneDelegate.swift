...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        // it must be executed before creating an instance of the TaskListController class
        // otherwise the data will be overwritten
        let tasks = TasksStorage().loadTasks()
        // loading the task list scene
        ...
        // transfer the list of tasks to the controller
